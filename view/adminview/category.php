               ...
               <button style="background-color:green"  > <a class="add-new" href="add-category.php">add category</a>  </button>
            </div>
              ...
              if (mysqli_num_rows($result) > 0) {
                  ...
                  while($row = mysqli_fetch_assoc($result)) {
                    $table .= "<tr>
                            ...
                            <td>{$row["post"]}</td>
                            <td class='edit'><a href='update-category.php?id={$row['category_id']}' ><button>update</button></a></td>
                            <td class='delete'><a href='../../controller/admincontroller/admindeletecategory.php?id={$row['category_id']}'><button>delete</button></a></td>
                        </tr>";
                        $serial++;
                  }
                  $table .= '</tbody></table>';
